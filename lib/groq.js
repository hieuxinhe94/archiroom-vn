...
export const prebuildproductListquery = groq `
*[_type == "prebuildproduct" && featured == true]  | order(publishedAt desc, _createdAt desc)  {
  ...,
  author->{name, image},
  categories[]->
}[0..6]
...
*[_type == "prebuildproduct" && slug.current == $slug][0] {
  ...,
  author->,
  categories[]->,
  "estReadingTime": round(length(pt::text(body)) / 5 / 180 )
