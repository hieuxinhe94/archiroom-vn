import { Tabs, Tab, Card, CardBody, CardFooter, CardHeader, Divider, Link, Textarea } from "@nextui-org/react";
...
export default function Tools(props) {
  ...
  const [prompt, setPrompt] = useState('Hãy thiết kế chung cư 2 PN diện tích 60 m2 có 2 PN và 1 WC theo phong cách Nhật Bản')
  ...
  return (
    ...
    <>
      ...
      <Head>
        <title>ArchiRoom.AI | Generative Architecture Vietnam </title>
        <link
          rel="canonical"
          href={"https://www.ArchiRoom.AI"}
          key="canonical"
        />
        ...
        <meta
          property="og:image"
          content="https://ArchiRoom.AI/logo-s.png"
        />
        <link
          rel="stylesheet"
          type="text/css"
        ...
        <div
          ...
          <div
            ...
            <h4 className="mx-auto mt-4 max-w-2xl text-2xl tracking-tight text-slate-700">
              # Generative AI: Đưa thiết kế kiến trúc lên tầm cao mới
            </h4>
            ...
            {isEditing ? <>
              ...
              <h1 onClick={() => setIsEditing(!isEditing)} className="mx-auto max-w-4xl cursor-pointer font-display text-4xl font-medium tracking-tight text-slate-900 sm:text-7xl mt-8">
                Hãy thiết kế căn hộ
                <span className="relative whitespace-nowrap text-blue-600">
                  ...
                  <span className="relative text-transparent  bg-clip-text bg-gradient-to-tr to-slate-500 from-blue-600"> {" "} 60 M2</span>
                </span>{" "}
                và
                <span className="relative text-transparent  bg-clip-text bg-gradient-to-tr to-slate-500 from-blue-600"> {" "} 2 PN</span> ,
                <span className="relative text-transparent  bg-clip-text bg-gradient-to-tr to-slate-500 from-blue-600"> {" "} 1 WC</span> ,
                theo phong cách  <span className="relative text-transparent  bg-clip-text bg-gradient-to-tr to-slate-500 from-blue-600"> {" "} Nhật bản </span>
                <br />
            ...
            <h4 onClick={() => setIsEditing(!isEditing)} className="mx-auto mt-4 max-w-2xl text-lg  text-white">
              {isEditing ? "Nhấn button để tạo thiết kế" : "! Click để chỉnh sửa yêu cầu ."}
            </h4>
            ...
            <div className="mt-10 flex justify-center px-4">
              <a
                ...
                color="slate"
                href={"/play-architecture?product=" + (isEditing ? "promt-architecture&prompt=" + prompt : "ai-architecture")}
              >
                <svg
                  aria-hidden="true"
        ...
        <main style={{
          ...
          <div className="w-full flex mx-auto justify-center">
            <div className="max-w-[1400px] flex  flex-col items-center justify-between">
              <div key={selectingProductId?.toString()} className="pt-12 lg:pt-12 w-full justify-center slider-container">
                <Slider {...heroSliderSetting.sliderConfig} >
                  {
                    heroSliderSetting?.archiroomPreviewData?.map((item) => (
                      <div key={item.id} className="my-4 py-2 px-2  lg:px-8">
                        <Card className="max-w-[400px] bg-amber-600 text-white">
                          ...
                          <CardBody>
                            <ImageComparison url1={item.image} url2={item.image2} />
                          </CardBody>
                        </Card>
                      </div>
                    ))
          ...
          <div className="w-full">
              ...
              <div className="md:text-center">
                <h2 className="font-display text-3xl tracking-tight tracking-tight text-slate-700">
                  <span className="relative  whitespace-nowrap">
                    ...
                    Phát triển và lớn mạnh <br /> <span className="relative text-transparent  bg-clip-text bg-gradient-to-tr to-emerald-500 from-amber-600"> cùng chúng tôi </span>
                  </span>{" "}
            ...
            <section
              ...
              className="relative overflow-hidden bg-amber-800 pt-20 "
            >
              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
                ...
                <div className="mt-16 grid grid-cols-1 items-center gap-y-2 pt-10 sm:gap-y-6 md:mt-20 lg:grid-cols-12 lg:pt-0">
                  ...
                  <div className=" px-12  pb-4 col-span-5">
                    <div
                    ...
                    >
                      ...
                      {
                        heroSliderSetting.archiroomFeatures.map((item) =>
                        (<div key={item.id} className="group relative rounded-full px-8 my-2 bg-white/5 lg:rounded-l-xl lg:rounded-r-none lg:p-6 hover:bg-white/10 lg:hover:bg-white/5">
                          <h3>
                            <button
                      ...
                      <div className="m-10 overflow-hidden rounded-xl  shadow-xl shadow-blue-900/20 sm:w-auto lg:mt-0 lg:w-[58rem] ">
                        <div className="slider-container">
                          <Slider {...heroSliderSetting.verticleSliderSettings}>
                            {
                              heroSliderSetting.archiroomFeatures.map((item, index) =>
                              (
                                <div
                                  key={index}>
                                  <div
              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-2xl md:text-center">
                  <h2 className="font-display text-3xl tracking-tight text-slate-900 sm:text-4xl">
                    AI nhưng phong cách <span className="relative text-transparent font-bold bg-clip-text bg-gradient-to-tr to-emerald-500 from-amber-600">
                      rất thực tế
                    </span>
                  </h2>
                  <div className="algin-center flex w-full flex-col h-[48px] mt-8 md:overflow-scroll lg:overflow-hidden">
                    <div className=" ">
                      ...
                      >
                        <Tab key="photos" title="Phong cách Á Đông">
                        </Tab>
                        <Tab key="music" title="Phong cách làng quê VN">
                        </Tab>
                        <Tab key="architecture" title="Phong cách châu Âu">
                        </Tab>
                      </Tabs>
                    </div>
                  </div>
                ...
                <div className=" lg:mt-20 lg:block">
                  ...
                  >
                    ...
                    {
                      heroSliderSetting.archiroomStyles.map((item, index) => (
            ...
            <section
              ...
              className="relative overflow-hidden bg-amber-800 py-32"
            >
