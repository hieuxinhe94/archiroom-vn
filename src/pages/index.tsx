          ...
          <div
            ...
            <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl mt-8">
              ...
              <span className="relative whitespace-nowrap text-blue-600">
                ...
                <span className="relative text-transparent  bg-clip-text bg-gradient-to-tr to-emerald-500 from-purple-600">ARCHIROOM.VN</span>
              </span>{" "}
              <br />
              {" "}
            </h1>
              ...
              <div className="md:text-center">
                <h2 className="font-display text-3xl tracking-tight tracking-tight text-slate-700">
                  <span className="relative  whitespace-nowrap">
                    ...
                    Phát triển và lớn mạnh <span className="relative text-transparent  bg-clip-text bg-gradient-to-tr to-emerald-500 from-purple-600"> cùng chúng tôi </span>
                  </span>{" "}
              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-2xl md:text-center">
                  <h2 className="font-display text-3xl tracking-tight text-slate-900 sm:text-4xl">
                    AI nhưng phong cách <span className="relative text-transparent font-bold bg-clip-text bg-gradient-to-tr to-emerald-500 from-purple-600">
                      rất thực tế
                    </span>
                  </h2>
