...
import clothesPhotos from '~/components/clothesPhotos'
...
import facebook from '../components/background-images/facebook.svg'
import instagram from '../components/background-images/instagram.svg'
...
import tryOnStep from '../components/background-images/try-on-step-1.png'
...
export default function TryonApp({ status = false, onCloseEvent, currentStep = 0, currentHumanUrl = '', currentClotheUrl = '', currentProductReferUrl = '', currentProductReferProvider = '' }) {
  ...
  const onCameraPressed = () => {
    setPicSOurce(PICTURE_SOURCE.CAMERA)
  ...
  const handleClothingImageUpload = useCallback(
    async (event: any) => {
      ...
      if (file) {
        ...
        currentUser.mainClothesPhoto = null;
                        ...
                        <div className="overflow-hidden grow relative rounded-[10px]">
                          ...
                          <div className="text-base p-[15px] font-bold review bg-clip-text text-transparent">
                            ...
                            <div className="sub-images flex gap-[3px] justify-center lg:justify-start  mt-[2px] lg:mt-[4px]">
                              ...
                              {currentUser.predictedPhotos?.map((item, index) => (
                                <Image2
                                  key={index}
                                  isZoomed
                                  src={'https://app.requestly.io/delay/6000/' + item}
                                  fallbackSrc={currentUser.predictedPhotos[index]}
