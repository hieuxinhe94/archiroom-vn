import { Button, Card, Modal, ModalBody, ModalContent, ModalFooter, ModalHeader, Progress, RadioGroup, Select, SelectItem, Skeleton, Tab, Tabs, VisuallyHidden, cn, useRadio } from '@nextui-org/react'
...
export default function PlayGroundArchitecture({ config, onCloseEvent }) {
  ...
  const [outputImageUploadedUrl, setOutputImageUploadedUrl] = useState("./services/architecture-ai-step-3.jpg")
      ...
      if (file) {
        ...
        imageKitService
          ...
          .then((uploaded) => {
            ...
            // temp
            setTimeout(() => {setCounter((v) => (v >= 100 ? 0 : v + 1));}, 1000)
          })
      ...
      <div className="flex h-[calc(100vh_-_40px)] w-full gap-x-2">
        ...
        <div className="flex hidden bg-slate-800 text-white h-full w-[344px] flex-shrink-0 flex-col items-start gap-y-8 rounded-large  px-8 py-6 shadow-small lg:flex">
          <button
            ...
            className="z-0 group relative inline-flex items-center justify-center box-border appearance-none select-none whitespace-nowrap subpixel-antialiased overflow-hidden tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 px-4 min-w-20 h-10 gap-2 rounded-full [&>svg]:max-w-[theme(spacing.8)] data-[pressed=true]:scale-[0.97] transition-transform-colors-opacity motion-reduce:transition-none data-[hover=true]:opacity-hover bg-default-50 text-small font-medium text-default-500 shadow-lg" type="button">
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" className="iconify iconify--solar" width={18} height={18} viewBox="0 0 24 24">
              <path fill="currentColor" fillRule="evenodd" d="M10.53 5.47a.75.75 0 0 1 0 1.06l-4.72 4.72H20a.75.75 0 0 1 0 1.5H5.81l4.72 4.72a.75.75 0 1 1-1.06 1.06l-6-6a.75.75 0 0 1 0-1.06l6-6a.75.75 0 0 1 1.06 0" clipRule="evenodd" />
            </svg>
            Back
          </button>
          <div>
            <div className="text-xl font-medium leading-7 ">Sketch to Image</div>

          </div>
          <div className='w-full text-white text-sm'>
            <RadioGroup label="Chọn đối tượng Gen ảnh:">
              <CustomRadio value="Tự động">
                Tự động
              </CustomRadio>
          ...
          <div className='w-full  font-bold'>
            <Select
              ...
              startContent={<div className='w-full flex text-sm'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 w-4 h-4 mx-2 my-1 text-slate-800">
                <path strokeLinecap="round" strokeLinejoin="round" d="m21 7.5-9-5.25L3 7.5m18 0-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" />
              </svg>
                <span className='text-slate-800'>{genType}</span></div>
              }
            ...
            >
              ...
              <SelectItem className='' key={"Chính xác"} value={"architecture.precise"}>
              ...
              <SelectItem className='' key={"Tương đối"} value={"architecture.balanced"}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                  <path strokeLinecap="round" strokeLinejoin="round" d="m21 7.5-9-5.25L3 7.5m18 0-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" />
                </svg>
              ...
              <SelectItem className='' key={"Sáng tạo"} value={"architecture.creative"}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                  <path strokeLinecap="round" strokeLinejoin="round" d="m21 7.5-9-5.25L3 7.5m18 0-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" />
                </svg>
                            ...
                            <li className="relative flex w-full items-center pr-12">
                              <button className="group flex w-full cursor-pointer flex-row items-center justify-center gap-x-3 rounded-large py-2.5">
                                ...
                                <div aria-hidden="true" className="pointer-events-none absolute right-0 w-10 flex-none items-center">
                                  <div className="relative h-0.5 w-full bg-[var(--inactive-bar-color)] transition-colors duration-300 after:absolute after:block after:h-full after:bg-[var(--active-border-color)] after:transition-[width] after:duration-300 after:content-[''] after:w-full" /></div></button>
                            </li>
                            <li className="relative flex w-full items-center pr-12">
                              <button className="group flex w-full cursor-pointer flex-row items-center justify-center gap-x-3 rounded-large py-2.5">
            ...
            <>
              ...
              <div className='w-full flex'>
                <div className='w-1/2 flex'>
                  <Card className="w-full h-[70vh] space-y-12 mx-12 p-8 " radius="lg">
                    <Skeleton isLoaded={isLoading} className="rounded-lg">

                      {
                        !isUploadingImage && (<div className="h-auto w-full flex justify-center rounded-lg bg-slate-800/20 pb-10">
                          <Image2
                            width={520}
                            height={580}
                      ...
                      {
                        isUploadingImage && (<div className="h-[154px] w-full rounded-lg bg-slate-800/20">
                    ...
                    {
                      isUploadingImage && (<div className="space-y-3 ">
                ...
                <div className='w-1/2 flex'>
                  <Card className="w-full h-[70vh] space-y-12 mx-12 p-8 " radius="lg">
                    <Skeleton isLoaded={isLoading} className="rounded-lg">
                      {
                        isLoading && (<div className="h-auto w-full flex justify-center rounded-lg bg-slate-800/20">
                          <Image2
                            width={520}
                            height={580}
                            isZoomed
                    ...
                    <div className="space-y-3 ">
                      <div className="flex gap-4 items-center">
                        <Button className='bg-slate-800 text-white' endContent={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        ...
                        <Button
                          ...
                          startContent={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 text-white">
