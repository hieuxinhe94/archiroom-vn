import { Button, Modal, ModalBody, ModalContent, ModalFooter, ModalHeader, Progress, Skeleton, Tab, Tabs } from '@nextui-org/react'
...
export default function PlayGroundChatBot({ config, onCloseEvent }) {
      ...
      <div className="flex h-full flex-col justify-center px-2">
        <div className="flex w-full flex-col items-center justify-center ">
          ...
          <h1 className="text-xl font-medium text-default-700">
            Chuyên gia ảo trong từng lĩnh vực
          </h1>
        </div>
        ...
        <div className="algin-center flex w-full flex-col  md:overflow-scroll lg:overflow-hidden">
          <div className=" ">
            ...
            >
              <Tab key="photos" title="Chuyên viên tuyển dụng">
              </Tab>
              <Tab key="music" title="Hỗ trợ khách hàng">
              </Tab>
              <Tab key="architecture" title="Đào tạo nội bộ">
              </Tab>
            </Tabs>
          </div>
        </div>

        {
          ...
          !isPlayingChat && (<div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 mt-10">
            <div
              ...
              <div className="relative w-full p-3 flex-auto place-content-inherit align-items-inherit h-auto break-words text-left overflow-y-auto subpixel-antialiased flex flex-col gap-2">
                <div className="flex min-h-[50px] rounded-medium bg-content3 px-3 py-2 text-content3-foreground">
                  <p className="text-small">
                    Công ty còn tuyển vị trí nhân viên kinh doanh không?
                  </p>
                </div>
                <div className="flex min-h-[50px] rounded-medium bg-content3 px-3 py-2 text-content3-foreground">
                  <p className="text-small">
                    Có vị trí nào bên công ty đang tuyển dụng không?
                  </p>
                </div>
              </div>
            </div>
