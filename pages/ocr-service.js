...
export default function OCRServices(props) {
              ...
              <div className="md:col-span-5 col-span-12 md:pr-8">
                <h2 className="text-base font-bold default:text-[#08445E] uppercase mb-7 richtext">
                  <TypeIt
                    options={{
                      strings: [
                        "Bóc tách thông thông tin, dữ liệu phi cấu trúc",
                      ],
                      speed: 0.5,
                      startDelay: 1000,
                      ...
                      ? features.map((model, key) => {
                          return (
                            ...
                            >
                              ...
                              <span
                                className={
                                  (activeModelIndex == key
                                    ? " bg-green-200/40 "
                                    : "") +
                                  "text-sm px-1  reduced-motion:group-hover:translate-x-0 -translate-x-5 transition-transform duration-500 will-change-transform group-hover:translate-x-2"
                                }
                              >
                                {model.title}
                              </span>
