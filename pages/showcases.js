          ...
          >
            <div className="container mb-10 grid grid-cols-12">
              <div className="md:col-span-8 col-span-12 md:pr-8">
                ...
                <p className="text-xl font-semibold h-36 mr-32 text-gray-300">
                  <TypeIt
                    options={{
                      strings: [
                      ...
                      return (
                        ...
                        >
                          ...
                          <span
                            ...
                            className="text-sm reduced-motion:group-hover:translate-x-0 -translate-x-5 transition-transform duration-500 will-change-transform group-hover:translate-x-2"
                          >
                            {post.title}
                          </span>
                          <svg
